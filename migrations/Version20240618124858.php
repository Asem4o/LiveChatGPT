 ...
 */
final class Version20240618124858 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE roles roles JSON NOT NULL, CHANGE profile_picture_path profile_picture_path VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE note CHANGE content content VARCHAR(255) DEFAULT \'NULL\', CHANGE created created DATETIME DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE notification CHANGE message message VARCHAR(255) DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE user CHANGE profile_picture_path profile_picture_path VARCHAR(255) DEFAULT \'NULL\', CHANGE roles roles LONGTEXT NOT NULL COLLATE `utf8mb4_bin`');
