 ...
 */
final class Version20240618130924 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD profile_picture VARCHAR(255) DEFAULT NULL, DROP profile_picture_path, CHANGE roles roles JSON NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE note CHANGE content content VARCHAR(255) DEFAULT \'NULL\', CHANGE created created DATETIME DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE notification CHANGE message message VARCHAR(255) DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE user ADD profile_picture_path VARCHAR(255) NOT NULL, DROP profile_picture, CHANGE roles roles LONGTEXT NOT NULL COLLATE `utf8mb4_bin`');
